...
class Calculator {
    ...
    choosOperation(operation) {
        ...
        if (this.previousLine != "") this.compute();
    ...
    updateDisplay() {
        ...
        previousLineTextElement.innerHTML = this.getDisplayNumber(this.previousLine);
    }
}
...
const calculator = new Calculator(previousLineTextElement, currentLineTextElement);
